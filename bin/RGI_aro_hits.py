...
def rgi_output(rgi_file):
    ...
    perf_sample_name = '{}_{}'.format(sample_name,"rgi_perfect_hits.csv")
    perf_file_name = ''.join(perf_sample_name)
    print(str(perf_file_name))

    strict_sample_name = '{}_{}'.format(sample_name,"rgi_strict_hits.csv")
    strict_file_name = ''.join(strict_sample_name)
    print(str(strict_file_name))

    loose_sample_name ='{}_{}'.format(sample_name,"rgi_loose_hits.csv")
